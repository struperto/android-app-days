...
val startAreaTemplates = listOf(
    ...
    StartAreaTemplate(
        ...
        tracks = listOf("Quellen", "Links", "Notizen", "Impulse"),
        drive = StartAreaDrive.Reflection,
        defaultIconKey = "book",
    ),
    StartAreaTemplate(
...
fun startAreaBlueprint(area: LifeArea): StartAreaBlueprint {
    ...
    return StartAreaBlueprint(
        ...
        entries = listOf(
            ...
            StartAreaEntry(StartAreaPanel.Options, "Flow", "Quellen, Erinnern und Review im Takt halten.", Icons.Outlined.Settings),
        ),
    )
}
