...
data class AreaStatusSemantics(
    ...
    val stateCoreTitle: String = "Aktueller Zustand",
    val stateActionLabel: String = "Zustand",
    val stateSheetTitle: String = "Zustand",
    val stateResetLabel: String = "Ohne Eintrag",
    val stateResetSummary: String = "ohne frischen Zustand",
    val stateMetricLabel: String = "Vertrauen",
...
fun scoreAreaSemantics(
    scorePrefix: String,
    scoreCoreTitle: String = "$scorePrefix heute",
...
fun stateAreaSemantics(
    ...
    stateMetricLabel: String = "Vertrauen",
    ...
    stateResetLabel: String = "Ohne Eintrag",
    stateResetSummary: String = "ohne frischen Zustand",
    direction: AreaDirectionSemantics = AreaDirectionSemantics(),
    sources: AreaSourceSemantics? = null,
    flow: AreaFlowSemantics? = null,
): AreaPilotSemantics {
