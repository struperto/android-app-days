...
class UserJourneyTest {
    ...
    fun user_canAdjustSleepGoal_andChangePersists() = runBlocking {
        ...
        try {
            ...
            composeRule.onNodeWithTag("settings-goal-sleep-min").performScrollTo().performTextClearance()
            composeRule.onNodeWithTag("settings-goal-sleep-min").performTextInput("7.5")
            composeRule.onNodeWithTag("settings-goal-sleep-save").performScrollTo().performClick()
